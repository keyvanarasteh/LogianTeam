...
class _HomePageState extends State<DiscoverPage> {
  final List<bool> _selected = [false, true, true];
  int pageController = 0;
  List<MovieCard> cards = [
    MovieCard(
        movieImage: "assets/interstellar.png",
        title: "Interstellar",
        description:
    ...
    MovieCard(
        movieImage: "assets/fight_club.png",
        title: "Fight Club",
        description:
            "Tyler'ın liderliğinde bir dövüş kulübünün kuruluşuyla bu kulüpte sayıları elliyi aşmamak kaydıyla genç erkekler birbirleriyle dövüşmeye başlayacaklardır. Kısa sürede popüler hale gelen kulüp ve Tyler hızlı bir şekilde bu ölü jenerasyonun mesihi haline gelir.",
        director: "David Fincher",
        starring: [
          "Edward Norton",
          "Brad Pitt",
    ...
    MovieCard(
        movieImage: "assets/whiplash.png",
        title: "Whiplash",
        description: "Whiplash, 2014 çıkışlı Amerikan drama filmi",
        director: "Damien Chazelle",
        starring: ["Miles Teller,", "J. K. Simmons,"],
        detail: ["1h 46m", "2014", "Drama", "4,2/5"]),
    MovieCard(
        movieImage: "assets/before_sunrise.png",
        title: "Before Sunrise",
        description:
            "Gün Doğmadan Önce, yolları kesişen bir kadın ve bir erkeğin hikayesini anlatıyor. Sıradan bir Avrupa yolculuğu sırasında trende karşılaşıp tanışan iki farklı insan, Jesse ve Celine bu yolculuğa sıradışı bir şekilde sürdürürler.",
        director: " Richard Linklater",
        starring: ["Ethan Hawke", "Julie Delpy"],
        detail: ["1h 17m", "2004", "Romantic", "4/5"]),
    MovieCard(
      ...
      detail: ["1h 40m", "2007", "Comedy", "2,4/5"],
    ),
    MovieCard(
        movieImage: "assets/recepivedik2.png",
        title: "Recep İvedik 2",
        description:
            "Recep'in tek akrabasi, kendisi gibi killi ve oldukça yasli babaannesidir. Babaanne, Recep'in yasadigi serkes, aylak hayati bırakip adam olmasini ister.",
        director: "Togan Gökbakar",
        starring: ["Şahan Gökbakar"],
        detail: ["1h 47m", "2009", "Comedy", "2.2/5"]),
    MovieCard(
        movieImage: "assets/recepivedik3.png",
        title: "Recep İvedik 3",
        description:
            "Babaannesinin ölümünden sonra depresyonda olan Recep'in evine beklenmedik bir ev arkadas gelir. Eve ihtiyaci olan bu genç hanim Recep'i depresyondan çikaran faktör olacaktir.",
        director: "Togan Gökbakar",
        starring: ["Şahan Gökbahar"],
        detail: ["1h 35m", "2010", "Comedy", "2/5"]),
    MovieCard(
      ...
      director: "Togan Gökbakar",
      starring: ["Şahan Gökbakar"],
      detail: ["1h 57m", "2014", "Comedy", "1,9/5"],
    ),
    MovieCard(
      movieImage: "assets/recepivedik5.png",
      title: "Recep İvedik 5",
      description:
          "Recep, bir şoför tanıdığının vefatı üzerine, taziyeye gider ve onun son aldığı işi yerine getirmek için gönüllü olur.",
      director: "Togan Gökbakar",
      starring: ["Şahan Gökbakar"],
      detail: ["1h 40m", "2017", "Comedy", "1,6/5"],
    ),
    MovieCard(
      movieImage: "assets/recepivedik6.png",
      title: "Recep İvedik 6",
      description:
          "Recep İvedik 6, Çamaşırhane Film imzalı, Togan Gökbakar'ın yönettiği ve senaryosunu Şahan Gökbakar ile birlikte yazdığı, Başrollerinde Şahan Gökbakar ve Nurullah Çelebi'nin yer aldığı Türk komedi filmi.",
      director: "Togan Gökbakar",
      starring: ["Şahan Gökbakar"],
      detail: ["1h 50m", "2019", "Comedy", "1,4/5"],
    ),
    MovieCard(
        movieImage: "assets/inception.png",
        title: "Incepiton",
        description:
            "Inception, Christopher Nolan tarafından yazılan ve yönetilen bilimkurgu türündeki ABD filmidir.",
        director: "Christopher Nolan",
        starring: ["Leonardo DiCaprio,", "Cillian Murphy,", "Tom Hardy,"],
        detail: ["2h 28m", "2010", "Sci-fi", "4,6"]),
  ];
  @override
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintStyle: TextStyle(
                                    color: Color.fromARGB(255, 77, 77, 93),
                                    fontWeight: FontWeight.bold),
                                prefixIcon: Icon(
                                  Icons.search,
                                  color: Color.fromARGB(255, 77, 77, 93),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: Colors.black38, width: 0.3),
                              boxShadow: const [
                                BoxShadow(
